...
async def play(_, message: Message):
    ...
    if audio:
        ...
        keyboard = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("📌 Groups", url="https://t.me/familykingxtaa),
                    InlineKeyboardButton("⛑ Channel", url="https://t.me/HeartCrackscnl"),
                ],
                [InlineKeyboardButton(text="🗑 Close", callback_data="cls")],
            ]
        )
...
async def deezer(client: Client, message_: Message):
    ...
    keyboard = InlineKeyboardMarkup(
        [
            [InlineKeyboardButton(text="⛑ Channel", url="https://t.me/HeartCrackscnl")],
        ]
    )
...
async def lol_cb(b, cb):
    ...
    keyboard = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("📌 Groups", url="https://t.me/familykingxtaa"),
                    InlineKeyboardButton("🛡️ Channel", url="https://t.me/HeartCrackscnl"),
                ],
                [InlineKeyboardButton(text="🗑 Close", callback_data="cls")],
            ]
        )
